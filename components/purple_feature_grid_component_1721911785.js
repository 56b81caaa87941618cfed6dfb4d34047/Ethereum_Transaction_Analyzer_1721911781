...
Vue.component("purple_feature_grid_component_1721911785", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve by tracking new Ethereum transactions as they occur. Our app provides real-time updates, allowing you to react swiftly to emerging opportunities or potential risks.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Go beyond surface-level details with our comprehensive transaction analysis tools. Gain valuable insights into transaction patterns, addresses involved, and potential connections or irregularities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Set custom alerts based on your specific criteria, such as transaction value thresholds, addresses of interest, or unusual activity patterns. Stay informed and take action when it matters most.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Leverage our intuitive data visualization tools to make sense of complex transaction data. Interactive charts, graphs, and dashboards help you identify trends and patterns at a glance.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">Advanced Filtering and Search</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our powerful filtering and search capabilities allow you to slice and dice transaction data according to your needs. Quickly pinpoint specific transactions, addresses, or patterns of interest.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">Secure and Decentralized Architecture</h4></div>
            </div>
